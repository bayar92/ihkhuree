...
export const aboutDefaults: AboutContent = {
  ...
  sectionLabels: {
    ...
    numbers: { mn: "ИХ ХҮРЭЭ ТООН ДЭЭР", en: "IKH KHUREE IN NUMBERS", ja: "数字で見るイフ・フレー" },
  ...
  stats: [
    ...
    { icon: "calendar", value: "10+", label: { mn: "Жилийн туршлага", en: "Years of Impact", ja: "年の実績" } },
  ],
  timeline: [
    {
      icon: "flag",
...
export const membershipDefaults: MembershipContent = {
  ...
  labels: {
    ...
    how: { mn: "ГИШҮҮН БОЛОХ ЗАМ", en: "HOW TO BECOME A MEMBER", ja: "会員になるには" },
    certificates: { mn: "ГИШҮҮНИЙ ГЭРЧИЛГЭЭ", en: "MEMBER CERTIFICATES", ja: "会員証" },
    countries: { mn: "ГИШҮҮН УЛСЫН ЦАР ХҮРЭЭ", en: "MEMBER COUNTRY REACH", ja: "会員国の広がり" },
  },
  heroSub: {
  ...
  benefits: [
    { icon: "globe", title: { mn: "Дэлхийн сүлжээ", en: "Global Network", ja: "グローバルネットワーク" }, text: { mn: "Дэлхийн бизнес, манлайлагчидтай холбогдоно.", en: "Connect with businesses and leaders worldwide.", ja: "世界中のビジネスやリーダーとつながります。" } },
    { icon: "handshake", title: { mn: "Бизнесийн боломж", en: "Business Opportunities", ja: "ビジネスチャンス" }, text: { mn: "Шинэ зах зээл, түншлэлд нэвтэрнэ.", en: "Access new markets and partnerships.", ja: "新しい市場やパートナーシップにアクセス。" } },
    { icon: "barChart", title: { mn: "Мэдлэг ба ойлголт", en: "Knowledge & Insights", ja: "知識と洞察" }, text: { mn: "Онцгой тайлан, арга хэмжээгээр мэдээлэлтэй байна.", en: "Stay informed with exclusive reports and events.", ja: "限定レポートやイベントで最新情報を入手。" } },
    { icon: "megaphone", title: { mn: "Танигдах байдал", en: "Visibility & Promotion", ja: "認知度と宣伝" }, text: { mn: "Дотоод болон олон улсад брэндээ таниулна.", en: "Increase your brand exposure locally and internationally.", ja: "国内外でブランドの露出を高めます。" } },
    { icon: "graduation", title: { mn: "Чадавх бэхжүүлэлт", en: "Capacity Building", ja: "能力開発" }, text: { mn: "Сургалт, семинар, хөгжлийн хөтөлбөрт оролцоно.", en: "Join training, workshops and development programs.", ja: "研修、ワークショップ、開発プログラムに参加。" } },
    { icon: "star", title: { mn: "Итгэлт нийгэмлэг", en: "Trusted Community", ja: "信頼されるコミュニティ" }, text: { mn: "Итгэлтэй, нэр хүндтэй нийгэмлэгийн нэг хэсэг бол.", en: "Be part of a trusted and reputable community.", ja: "信頼され評判の高いコミュニティの一員に。" } },
  ],
  types: [
    {
      icon: "crown",
      name: { mn: "Exclusive Member (Ноён)", en: "Exclusive Member (Noyon)", ja: "エクスクルーシブ会員（ノヨン）" },
      price: "$10,000",
      monthly: "$833",
      features: [
        { mn: "Клубын хүндэт зөвлөх статустай болох", en: "Honorary advisor status within the club", ja: "クラブ内の名誉アドバイザーステータス" },
        { mn: "Стратегийн шийдвэр гаргах түвшинд оролцох", en: "Participate at the strategic decision-making level", ja: "戦略的意思決定レベルへの参加" },
        { mn: "Клубын нэрийн өмнөөс олон улсын хамтын ажиллагаа хөгжүүлэх", en: "Develop international cooperation on behalf of the club", ja: "クラブ名義での国際協力の推進" },
        { mn: "Онцгой хаалттай хөрөнгө оруулалтын боломжуудад нэвтрэх", en: "Access to exclusive closed investment opportunities", ja: "特別な限定投資機会へのアクセス" },
        { mn: "Насан туршийн VIP гишүүнчлэлийн статус", en: "Lifetime VIP membership status", ja: "生涯VIP会員ステータス" },
      ],
    },
    {
      icon: "gem",
      name: { mn: "Elite ангилал (Тайж)", en: "Elite Class (Taij)", ja: "エリートクラス（タイジ）" },
      price: "$5,000",
      monthly: "$417",
      featured: true,
      badge: { mn: "ЭРЭЛТТЭЙ", en: "POPULAR", ja: "人気" },
      features: [
        { mn: "Клубыг төлөөлөн албан ёсны арга хэмжээнд оролцох", en: "Represent the club at official events", ja: "公式イベントでのクラブ代表" },
        { mn: "Олон улсын түнш байгууллагуудтай шууд холбогдох", en: "Direct connection with international partner organizations", ja: "国際パートナー組織との直接連携" },
        { mn: "Бизнесийн зөвлөх үйлчилгээ авах", en: "Receive business advisory services", ja: "ビジネスアドバイザリーサービス" },
        { mn: "Хамтарсан төсөл санаачлах, удирдах эрх", en: "Right to initiate and lead joint projects", ja: "共同プロジェクトの企画・主導権" },
        { mn: "VIP зочдыг урих тусгай эрх", en: "Special privilege to invite VIP guests", ja: "VIPゲスト招待の特別権限" },
      ],
    },
    {
      icon: "award",
      name: { mn: "Senior Member (Ван)", en: "Senior Member (Van)", ja: "シニア会員（ヴァン）" },
      price: "$1,500",
      monthly: "$125",
      features: [
        { mn: "Хаалттай бизнес форумд оролцох", en: "Access to closed business forums", ja: "クローズドビジネスフォーラムへの参加" },
        { mn: "Хөрөнгө оруулагчидтай холбогдох боломж", en: "Opportunities to connect with investors", ja: "投資家との接続機会" },
        { mn: "Компанийн танилцуулгыг клубын сувгаар түгээх", en: "Promote your company profile through club channels", ja: "クラブチャネルでの企業紹介" },
        { mn: "Тусгай сургалт, мастер класст үнэ төлбөргүй хамрагдах", en: "Free access to exclusive training and masterclasses", ja: "特別研修・マスタークラスへの無料参加" },
        { mn: "Олон улсын арга хэмжээний давуу эрх", en: "Priority access to international events", ja: "国際イベントへの優先参加" },
      ],
    },
    {
      icon: "shield",
      name: { mn: "Middle Member (Засагт)", en: "Middle Member (Zasagt)", ja: "ミドル会員（ザサグト）" },
      price: "$1,000",
      monthly: "$83",
      features: [
        { mn: "Хаалттай Middle Member Circle-д гишүүнээр элсэх", en: "Join the closed Middle Member Circle", ja: "クローズドMiddle Member Circleへの参加" },
        { mn: "Дээд түвшний хөрөнгө оруулагчидтай уулзах боломж", en: "Meet with top-tier investors", ja: "トップレベルの投資家との面会" },
        { mn: "Стратегийн зөвлөхүүдтэй ганцаарчилсан уулзалт", en: "One-on-one meetings with strategic advisors", ja: "戦略アドバイザーとの個別面談" },
        { mn: "Клубын үйл ажиллагааны бодлогод санал өгөх эрх", en: "Right to contribute to club policy decisions", ja: "クラブ運営方針への意見提出権" },
        { mn: "Олон улсын дээд түвшний төлөөлөгчдийн арга хэмжээнд тусгай урилга", en: "Special invitations to high-level international events", ja: "国際ハイレベルイベントへの特別招待" },
      ],
    },
    {
      icon: "user",
      ...
      monthly: "$41",
      features: [
        { mn: "Клубын албан ёсны гишүүнчлэл", en: "Official club membership", ja: "クラブの正式会員資格" },
        { mn: "Сар тутмын уулзалт, арга хэмжээнд оролцох эрх", en: "Access to monthly meetings and events", ja: "月例会・イベントへの参加権" },
        { mn: "Гишүүдийн сүлжээнд нэвтрэх боломж", en: "Access to the members' network", ja: "会員ネットワークへのアクセス" },
        { mn: "Мэдээллийн товхимол, бизнесийн мэдээлэл авах", en: "Receive newsletters and business insights", ja: "ニュースレターとビジネス情報の受信" },
        { mn: "Клубын онлайн платформ ашиглах эрх", en: "Access to the club's online platform", ja: "クラブオンラインプラットフォームの利用" },
      ],
    },
  ],
  countries: [
  ...
  steps: [
    { icon: "fileText", no: "01", title: { mn: "ӨРГӨДӨЛ ГАРГАХ", en: "SUBMIT APPLICATION", ja: "申請を提出" }, text: { mn: "Гишүүнчлэлийн өргөдлийн маягтыг бөглөнө.", en: "Fill out the membership application form.", ja: "会員申請フォームに記入します。" } },
    { icon: "search", no: "02", title: { mn: "ХЯНАЛТ", en: "REVIEW PROCESS", ja: "審査" }, text: { mn: "Манай баг таны өргөдлийг хянана.", en: "Our team will review your application.", ja: "当協会のチームが申請を審査します。" } },
    { icon: "check", no: "03", title: { mn: "БАТАЛГААЖУУЛАЛТ", en: "APPROVAL", ja: "承認" }, text: { mn: "Гишүүнчлэлийн баталгаажуулалт хүлээн авна.", en: "Receive confirmation of your membership.", ja: "会員資格の確認を受け取ります。" } },
    { icon: "users", no: "04", title: { mn: "ХОЛБОГДОХ", en: "GET CONNECTED", ja: "つながる" }, text: { mn: "Дэлхийн сүлжээтэй холбогдож өсч эхэлнэ.", en: "Start connecting and grow with our global network.", ja: "グローバルネットワークとつながり成長を始めます。" } },
  ],
...
export const homeDefaults: HomeContent = {
  aboutTeaser: {
    ...
    title1: { mn: "Хил дамнан холбож,", en: "Bridging borders.", ja: "国境を越えてつなぎ、" },
    title2: { mn: "хамтын ажиллагааг бэхжүүлнэ.", en: "Empowering cooperation.", ja: "協力を強化する。" },
    text: {
      mn: "Бид олон улсын бизнесийн хамтын ажиллагааг шинэ түвшинд хүргэж, байгууллага, хөрөнгө оруулагчид болон бизнес эрхлэгчдийг холбох замаар урт хугацааны үнэ цэнэ бүхий түншлэлийг бий болгож, тогтвортой өсөлт хөгжил, инноваци, эдийн засгийн үр өгөөжийг дэмжихийг эрхэмлэдэг.",
      en: "We are committed to elevating international business cooperation to a new level by connecting organizations, investors, and entrepreneurs — building long-term, value-creating partnerships and supporting sustainable growth, innovation, and economic prosperity.",
      ja: "国際ビジネス協力を新たなレベルに引き上げ、組織、投資家、起業家をつなぐことで、長期的な価値を創造するパートナーシップを構築し、持続可能な成長、イノベーション、経済的繁栄を支援することを使命としています。",
