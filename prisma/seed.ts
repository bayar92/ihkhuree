    ...
    data: [
      {
        ...
        order: 1,
        label: {
          mn: 'Худалдаа ба хөрөнгө оруулалт',
          en: 'Trade & Investment',
          ja: '貿易と投資',
        },
      },
      ...
      },
      {
        ...
        order: 4,
        label: {
          mn: 'Боловсрол ба чадавхжуулалт',
          en: 'Education & Capacity Building',
          ja: '教育と能力開発',
        },
      },
      {
  ...
  const pages = [
    ...
    },
    {
      ...
      body: [
        ...
        {
          heading: {
            mn: 'Олон улсын хамтын ажиллагаа',
    ...
    data: [
      {
        ...
        link: 'https://docs.google.com/forms/d/e/1FAIpQLSdspWZdhvLhdr5vn-eruBOKSkg3sGtuSpi_GvrfF88nEmQvdQ/viewform',
        title: {
          mn: '"MONGOLIAN DAY IN TOKYO" powered by TENT Group',
          en: '"MONGOLIAN DAY IN TOKYO" powered by TENT Group',
          ja: '"MONGOLIAN DAY IN TOKYO" powered by TENT Group',
        },
        location: {
          mn: 'Токио хот, Нихонбаши',
          en: 'Nihonbashi, Tokyo',
          ja: '東京都・日本橋',
        },
        description: {
          mn: 'Олон улсын хөрөнгө оруулалт, санхүүгийн салбарын 300 гаруй удирдах түвшний төлөөлөгчидтэй уулзаж, "TORGONY ZAM Summit 2026" олон улсын хөрөнгө оруулалтын чуулга-ын ач холбогдол, хөрөнгө оруулалтын боломжууд болон хамтын ажиллагааны шинэ чиглэлүүдийг танилцуулна.',
          en: 'Meeting over 300 senior-level representatives from the international investment and finance sector to present the significance of the "TORGONY ZAM Summit 2026" international investment forum, investment opportunities, and new directions for cooperation.',
          ja: '国際投資・金融分野の300名以上の経営幹部と面会し、「TORGONY ZAM Summit 2026」国際投資フォーラムの意義、投資機会、協力の新たな方向性を紹介します。',
        },
      },
      {
        slug: 'torgony-zam-summit-2026',
        startsAt: new Date('2026-08-10T08:00:00Z'),
        endsAt: new Date('2026-08-15T21:00:00Z'),
        image: '/images/tzam.jpg',
        link: 'https://torgonyzam.com/',
        title: {
          mn: '"TORGONY ZAM SUMMIT 2026"',
          en: '"TORGONY ZAM SUMMIT 2026"',
          ja: '"TORGONY ZAM SUMMIT 2026"',
        },
        location: {
          mn: 'Улаанбаатар, Хэнтий',
          en: 'Ulaanbaatar, Khentii',
          ja: 'ウランバートル、ヘンティー',
        },
        description: {
          mn: 'Энэхүү арга хэмжээ нь Монгол Улсын хөрөнгө оруулалтын боломж, стратегийн төслүүд, олон улсын хамтын ажиллагааг дэмжих зорилготой олон улсын хэмжээний хөрөнгө оруулалтын дээд хэмжээний уулзалт юм.',
          en: 'This event is a high-level international investment gathering aimed at showcasing Mongolia’s investment opportunities, strategic projects, and supporting international cooperation.',
          ja: '本イベントは、モンゴル国の投資機会、戦略的プロジェクト、国際協力を支援することを目的とした、国際的なハイレベル投資フォーラムです。',
        },
      },
      {
        slug: 'ikh-khuree-members-meeting-tokyo-2026',
        startsAt: new Date('2026-09-01T09:00:00Z'),
        endsAt: new Date('2026-09-30T21:00:00Z'),
        title: {
          mn: '“Их Хүрээ” Олон Улсын Бизнесийн Хамтын Ажиллагааны Холбооны Гишүүдийн Тусгай Уулзалт',
          en: 'Special Meeting of “Ikh Khuree” International Business Cooperation Association Members',
          ja: '「イヒ・フレエ」国際ビジネス協力連盟 会員特別会合',
        },
        location: {
          mn: 'Токио хот, Япон Улс',
          en: 'Tokyo, Japan',
          ja: '東京都、日本',
        },
        description: {
          mn: '“Их Хүрээ” Олон Улсын Бизнесийн Хамтын Ажиллагааны Холбооны гишүүдийн ээлжит тусгай уулзалт Токио хотноо зохион байгуулагдана. Тус уулзалтын хүрээнд холбооны гишүүд харилцан мэдээлэл солилцож, хөрөнгө оруулалт болон бизнесийн хамтын ажиллагааны боломжуудын талаар хэлэлцэн, олон улсын түншлэлийг өргөжүүлэх, шинэ төсөл, санаачилгуудыг дэмжих чиглэлээр санал солилцоно.',
          en: 'A special periodic meeting of members of the “Ikh Khuree” International Business Cooperation Association will be held in Tokyo. Members will exchange information, discuss investment and business cooperation opportunities, and share ideas on expanding international partnerships and supporting new projects and initiatives.',
          ja: '「イヒ・フレエ」国際ビジネス協力連盟の会員による特別会合が東京で開催されます。会員同士が情報交換を行い、投資およびビジネス協力の機会について議論し、国際パートナーシップの拡大や新たなプロジェクト・イニシアチブの支援に向けた意見交換を行います。',
        },
      },
    ],
  });
